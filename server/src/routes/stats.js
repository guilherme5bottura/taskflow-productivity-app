...
router.get('/dashboard', async (req, res) => {
  try {
    ...
    const total = Number(counts.total_tasks) || 0;
    const completed = Number(counts.completed_tasks) || 0;
